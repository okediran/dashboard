    ...
    return (
        <div className="Home">
            <div class="form-head mb-sm-5 mb-3 d-flex flex-wrap">
                <h2 class=" title mb-2 ">Dashboard</h2>
                <div class="d-flex weather-btn mb-2">
                    <div className="weather">
                        <span class="mr-3 font-w600 text-black"><i class="fa fa-cloud mr-2"></i>21</span>
                        <select class="form-control style-1 default-select mr-3" tabindex="-98">
                ...
                <a href="" class="btn btn-secondary mb-2">
                    <i class="fa fa-calendar scale5 mr-3">
                    </i>Filter Periode
                </a>
			</div>
